  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Permission',
        meta: { title: '角色授权', icon: '', affix: false }
      },
      {
        path: 'operator',
      ...
      },
      {
        ...
        meta: { title: '默认参数', icon: '', affix: false }
      },
      {
        path: 'shuibiao',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '水表批量操作', icon: '', affix: false }
      },
      {
        path: 'close-account',
        component: () => import('@/views/user-management/close-account/index'),
        name: 'CloseAccount',
        meta: { title: '用户销户', icon: '', affix: false }
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '操作记录', icon: '', affix: false }
      }
    ]
  },
  {
